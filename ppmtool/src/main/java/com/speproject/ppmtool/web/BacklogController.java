...
import com.speproject.ppmtool.services.ProjectTaskService;
...
@CrossOrigin        // to make calls from react app
public class BacklogController {
    ...
    @PatchMapping("/{backlog_id}/{pt_id}")              // for updation we use patch
